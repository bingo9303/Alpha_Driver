...
#define LED_NAME	"platform_deviceTree"
#define LED_CNT		1
...
static const struct of_device_id led_device_id[] = 
{
	[0] = 
		{
			.compatible = "bingo,led-gpio",			
		},
	[1] = 
		{},//最后一个必须全空
};
...
static struct platform_driver led_platform_driver = 
{
	...
	.driver = 
		{
			.name = "led-bingo-platform-gpio-deviceTree",
